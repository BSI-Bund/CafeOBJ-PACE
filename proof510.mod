...
open ISTEP 
 ...
 --
 -- eq (me3(p10,p10,q10,mac(hash(rand(expo(m222)),expo(m221)),expo(m221),dpar(cipher1(m100)))) = m20)
 eq creator(m20) = p10 .
 eq sender(m20) = p10 .
 eq receiver(m20) = q10 .
 ...
 --
 eq s' = sdm3(s,p10,q10,m100,m221,m222) .
 red inv160(s,m221) implies istep510(m20) .
close
...
open ISTEP 
 ...
 --
 eq s' = fkm31(s,p10,q10,c30) .
 red inv450(s,c30) implies istep510(m200) .
close
...
open ISTEP 
 ...
 --
 eq (me3(intruder,p10,q10,mac(hash(r10,e10),e20,d10)) = m200) = false .
 --
 eq s' = fkm32(s,p10,q10,r10,e10,e20,d10) .
 red istep510(m200) .
close
...
open ISTEP 
 ...
 --
 -- eq (me3(intruder,p10,q10,mac(hash(r10,e10),e20,d10)) = m200) .
 eq creator(m200) = intruder .
 eq sender(m200) = p10 .
 eq receiver(m200) = q10 .
 ...
 --
 eq s' = fkm32(s,p10,q10,r10,e10,e20,d10) .
 red inv170(s,e10) implies istep510(m200) .
close
